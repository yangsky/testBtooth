//
//  BTFPeripheralserviceTableViewController.m
//  BTF
//
...
@interface BTFPeripheralserviceTableViewController ()

@end

@implementation BTFPeripheralserviceTableViewController
    ...
    if (self.connectedPeripheral) {
        [self.connectedPeripheral discoverServices:nil onFinish:^(NSError *error){
            ...
            for (CBService *service in weakSelf.serviceArray) {
                [weakSelf retriveCharacteristicWithServiceBTF:service];
            }
        }];
    }
...
-(void)retriveCharacteristicWithServiceBTF:(CBService *)service
{
    WEAKSELF;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *string = [self GetCharacteristicPropertiesBTF:characteristic];
...
-(NSString *)GetCharacteristicPropertiesBTF:(CBCharacteristic *)characteristic
{
    CBCharacteristicProperties temProperties = characteristic.properties;
